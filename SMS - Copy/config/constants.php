...
define('APP_HOST_ROOT', $_SERVER['HTTP_HOST'] . '/SMS'); // Example: localhost/SMS
...
define('APP_PPORTAL_MENU', APP_PPORTAL . '/header.php');  // /var/www/html/SMS/views/portals//////
// define('APP_ADMIN_MENU', APP_ADMIN_URL . '/header.php');  // /var/www/html/SMS/views/portals//////
define('APP_ADMIN_MENU', APP_SPORTAL . '/admin/header.php'); // ✅ Correct - server file path
?>